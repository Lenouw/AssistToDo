...
public enum ParsePromptBuilder {
    public static func systemPrompt(now: Date, calendars: [String] = [], reminderLists: [String] = []) -> String {
        ...
        {"tasks":[{"text":"...","destination":"local|reminders|calendar|notes","remindAt":"ISO8601 avec offset ou null","dueDate":"YYYY-MM-DD ou null","durationMinutes":60,"calendarName":"nom de calendrier ou null","listName":"nom de liste Rappels ou null","noteName":"nom de note ou null","priority":"bas|moyen|haut ou null","notify":true|false,"tags":[]}]}
